...
exports.config = {
    ...
    suites: {    
        ...
        API : [
            './e2e/specs/api/GetPets1.spec.js'   
        ],

        regression : [
            './e2e/specs/ui/*.spec.js'   
        ],
    ...
    // gets prepended directly.
     baseUrl: url[ENV],
    question: process.env.User ? process.env.User: 'What is your good name?',
    answer: process.env.Password ? process.env.Password:'Monu Kumar',
    //
